#
#  Be sure to run `pod spec lint MagicPage.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "zhuyitian"
  # spec.authors            = { "zhuyitian" => "zhuyitian@hashxy.com" }
  # spec.social_media_url   = "https://twitter.com/zhuyitian"
  ...
  spec.source       = { :git => "https://github.com/zhuyitian/MagicPage.git", :tag => "#{spec.version}" }
  ...
  spec.frameworks = "SafariServices", "SystemConfiguration", "LocalAuthentication", "iAd", "AdSupport"
